...
router.patch('/update', authenticate, validateBody(userSchema), upload.single('avatar'), ctrlWrapper(updateUserController));
router.post('/refresh-tokens', ctrlWrapper(refreshTokensController));
router.post('/logout', authenticate, ctrlWrapper(logoutUserController));
router.post('/send-reset-email', validateBody(requestResetEmailSchema), ctrlWrapper(sendResetPasswordEmailController));
...
router.post('/verify-google-oauth', validateBody(validateGoogleOAuthSchema), ctrlWrapper(verifyGoogleOAuthController));
